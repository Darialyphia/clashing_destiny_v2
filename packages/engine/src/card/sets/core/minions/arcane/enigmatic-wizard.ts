...
export const enigmaticWizard: MinionBlueprint = {
  ...
  description: dedent /*html*/ `
    <rt-location locations="battlefield"><rt-trigger>Start of Turn</rt-trigger> Put an <rt-card>Arcane Spark</rt-card> in your hand. <br /><rt-runes runes="focus,resonance"></rt-runes>This can also happen in base.
    </rt-location>
  `,
  collectable: true,
  setId: CARD_SETS.CORE,
  art: defaultCardArt('minions/enigmatic-wizard'),
