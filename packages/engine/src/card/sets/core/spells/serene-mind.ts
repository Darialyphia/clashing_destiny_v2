...
export const sereneMind: SpellBlueprint = {
  ...
  description: dedent`Look at your opponent's hand and choose a card that they are able to play. At the end of the turn, if they haven't played that card, draw 2 cards.`,
  collectable: true,
  unique: false,
  destinyCost: 1,
