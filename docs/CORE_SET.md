...
-> (1)(fast): Deal 1 damage to an enemy minion. Increase the cost of this ability by 1.
...
Deal 3 damage to a minion. If it dies, deal 1 damage to all other minions in the same zone.
