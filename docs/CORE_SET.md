...
Cannot be played. When this is in your Destiny Zone, banish this card at the end of the turn.
(this card exists as a way to enable soft ramping without including card draw, because of the mana system).
...
Loyalty 1.
On Enter: Transform into an exact copy of target minion.

Mana-Fueled Golem
Minion | Arcane | (3) | MMK | 0 / 3 | (slow)
Has + Atk equal to your Spellpower.
...
Astral Soldier
Minion | Arcane | (2) | K | 1 / 2 | (slow)
On Enter: you may Consume K. If you do, empower 1.
Foresight.
...
On Destroyed: draw 2 cards int oyour Destiny Zone. Level 3 bonus: Draw them into your hand instead.
...
-> (1): gain K until the end of the turn.

Mana Looter
Minion | Arcane | (3) | KF | 1 / 3 | (slow)
On Hero Hit: draw a card.
-> (2) : give this unit Stealth until the end of the turn, then wake up this minion.

Arcane Conduit
Minion | Arcane | 2 | KK | 1 / 1 | (slow)
When you play an Arcane spell, this gains +1ATK until the end of turn. Then, you may consume K. If you do, wake up this minion.
